...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="col-sm-4" style="margin-top:15px;font-family: 'Bebas Neue', cursive; font-size:20px; margin-top:240px;"></div>
        <div class="col-sm-4">
            ...
            <br />
            <br />
            <div class="teste1"><b><asp:Panel runat="server" ID="lblTeste"></asp:Panel></b></div>
