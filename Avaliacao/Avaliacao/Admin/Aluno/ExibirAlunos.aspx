...
<div> <h2 class="titulo text-center" style="font-family: Impact, fantasy">Exibir Alunos
   ...
   <asp:TextBox runat="server" CssClass="fodase" ID="txtNome" placeholder="Digite o aluno para pesquisar"></asp:TextBox>
    ...
    <asp:Button runat="server" CssClass="button" ID="CadastrarAluno" Text="Cadastrar Novo Aluno" OnClick="CadastrarAluno_Click"/>
