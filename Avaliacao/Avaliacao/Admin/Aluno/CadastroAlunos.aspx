...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron" style="background-color: #65A1A6">
        <div>
            <h2 class="titulo text-center" style="font-family: Impact, fantasy">Cadastrar alunos
         <asp:Image runat="server" ID="Image1" src="/../../imgs/icons8_Student_Male_48.png" /></h2>
        </div>
        ...
        <div class="container">
            ...
            <asp:TextBox runat="server" CssClass="fodase" ID="txtNome"></asp:TextBox>
